...
$(document).ready(function(){
  ...
  // Back to top button
  var backToTopButton = $('<button id="back-to-top" class="back-to-top" aria-label="Back to top" title="Back to top"><i class="fas fa-chevron-up"></i></button>');
  ...
  $(window).scroll(function() {
    $('.paper-box, .news-item, .education-item').each(function() {
